...
if($name && $nig && $password && $lesson){
    $sql1 = "insert into teacher (name, nig, password, lesson) values ('$name', '$nig', '$password',  '$lesson')";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Insert Teacher</h5>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST">
                    ...
                    <div class="col-12">
                      <a href="tables-data.php"><button class="btn btn-primary w-100" type="submit" name="addbutton" id="addbutton">ADD</button></a>
                    </div>
                  </form>
